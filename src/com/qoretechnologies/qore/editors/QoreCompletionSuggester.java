...
public class QoreCompletionSuggester
{
	...
	{
		CompletionDocbookLoader loader = new CompletionDocbookLoader();
		qoreFunctions = loader.loadElements("resources/qore-functions.xml");
		qoreClasses = loader.loadElements("resources/class-lib.xml");
